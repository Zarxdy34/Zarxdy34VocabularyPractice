...
void Delete_HTML(string &s)
{
	...
	{
		if (s.substr(i,13) == "\\u003cb\\u003e") s.erase(i,13);
		if (s.substr(i,14) == "\\u003c/b\\u003e") s.erase(i,14);
	}
}
	...
	struct Example_Sentence
	{
		...
		void Print(int ctr)
		{
			...
			for (auto x = sentence.begin(); x != sentence.end() && x != sentence.begin() + maxnum; ++x)
				cout << (x - sentence.begin()) + 1 << ":" << x->sentence << endl;
		}
	}Info13;
...
int main(int argc,char **argv)
{
	...
	for (int i = 2; i < argc; i++)
	{
		if (strcmp(argv[i], "d") == 0) 
			WDInfo.Info12.Print(0);
		if (strcmp(argv[i], "D") == 0) 
			WDInfo.Info12.Print(1);
		if (strcmp(argv[i], "s") == 0)
			WDInfo.Info13.Print(0);
		if (strcmp(argv[i], "S") == 0)
			WDInfo.Info13.Print(1);
		if (strcmp(argv[i], "p") == 0)
			WDInfo.Info14.Print(0);
		if (strcmp(argv[i], "P") == 0)
			WDInfo.Info14.Print(1);
	}
	return 0;
}
